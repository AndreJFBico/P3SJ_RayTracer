...
void loadScene(Scene *s)
{
	...
	//scene->loadObj("..\\objs\\IvonovasFury_Blend_Swap.obj", true, glm::vec3(0.8f, 0.8f, 0.8f) , 0.0f);
	//scene->loadObj("..\\objs\\Xephyr.obj", true, glm::vec3(0.8f, 0.8f, 0.8f), 0.0f);
	...
	scene->loadObj("..\\objs\\water.obj", true, glm::vec3(184.0f / 255.0f, 174.0f / 255.0f, 255.0f / 255.0f), 0.2f, 1.0f);
